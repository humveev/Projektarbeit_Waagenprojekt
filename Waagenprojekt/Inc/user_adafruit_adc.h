...
#ifndef USER_ADAFRUIT_ADC_H_
#define USER_ADAFRUIT_ADC_H_
...
-----------------------------------------------------------------------*/
	...
	#define ADS1115_ADDRESS                 (0x48<<1)    // 100 1000 (ADDR = GND)
...
typedef enum
{
	GAIN_TWOTHIRDS = ADS1115_REG_CONFIG_PGA_6_144V,	// 0x0000-0x7FFF -> bits * 0.000'187'5 V
	GAIN_ONE = ADS1115_REG_CONFIG_PGA_4_096V,		// 0x0000-0x7FFF -> bits * 0.000'125 V
	GAIN_TWO = ADS1115_REG_CONFIG_PGA_2_048V,		// 0x0000-0x7FFF -> bits * 0.000'062'5 V
	GAIN_FOUR = ADS1115_REG_CONFIG_PGA_1_024V,		// 0x0000-0x7FFF -> bits * 0.000'031'25 V
	GAIN_EIGHT = ADS1115_REG_CONFIG_PGA_0_512V,		// 0x0000-0x7FFF -> bits * 0.000'015'625 V
	GAIN_SIXTEEN = ADS1115_REG_CONFIG_PGA_0_256V	// 0x0000-0x7FFF -> bits * 0.000'007'812'5 V
...
//void Adafruit_ADS1115(uint8_t addr);
//void Adafruit_ADS1115_begin(void);
uint16_t Adafruit_ADS1115_SingleEnded(uint8_t channel);
//int16_t Adafruit_ADS1115_Differential_0_1(void);
//int16_t Adafruit_ADS1115_Differential_2_3(void);
//void Adafruit_ADS1115_Comperator_SingleEnded(uint8_t channel, int16_t threshold);
//int16_t Adafruit_ADS1115_getLastConversionResult(void);
//void Adafruit_ADS1115_setGain(adsGain_t gain);
//adsGain_t Adafruit_ADS1115_getGain(void);



#endif /* USER_ADAFRUIT_ADC_H_ */
